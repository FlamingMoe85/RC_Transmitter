...
void Wizard_IntTrim::Enter(Graph_App_I** curNode, UI_Visitor_I* UiVis)
{
	myRef->Generate();
}

void Wizard_IntTrim::Esc(Graph_App_I** curNode, UI_Visitor_I* UiVis)
{
	(**curNode).Esc(curNode);
...
void Wizard_IntTrim::SetIntTrimWiz_Ref(Wizard_InternTrim* ref)
{
	myRef = ref;
